...
\begin{lstlisting}[style=mypython][basicstyle=\scriptsize\ttfamily, frame=single]
...
\begin{itemize}
  ...
  \item En iteración de punto fijo, cuando converge, lo hace linealmente: lento pero seguro.
...
\begin{frame}{Ejemplo 4: Análisis del Error}
...
\begin{frame}{Ejemplo 6: Resumen de Iteraciones}
